...
<div class="w-full p-8 bg-white shadow text-center mb-8 ">
    <svg width="64" height="64" class="flex-inline mb-2 fill-current text-grey-darkest hover:text-blue">
        <path fill="none" d="M-1-1h55.333v55.333H-1z" />
        <g>
            <circle fill="#fff" r="32" cy="32" cx="32" />
            <path fill="fill-current" d="M32 64a32 32 0 1 1 0-64 32 32 0 0 1 0 64zm0-2a30 30 0 1 0 0-60 30 30 0 0 0 0 60z"
            />
    ...
    <div class="text-center">
        <a class="text-grey-dark hover:text-blue" aria-label="Github" rel="noreferrer" href="https://github.com/johanleroux" target="_blank">
        ...
        <a class="text-grey-dark hover:text-blue" aria-label="Linkedin" rel="noreferrer" href="https://www.linkedin.com/in/johan-roux-802434109/" target="_blank">
        ...
        <a class="text-grey-dark hover:text-blue" aria-label="Twitter" rel="noreferrer" href="https://twitter.com/johan_irl" target="_blank">
        ...
        <a class="text-grey-dark hover:text-blue" aria-label="Email" rel="noreferrer" href="mailto:mail@johanleroux.me" target="_blank">
